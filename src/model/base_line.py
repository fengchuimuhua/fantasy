...
# A rmse: 2.277584
user_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/dataset/t_user.csv'
loansum_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/dataset/t_loan_sum.csv'
res_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/submit/1127_baseline.csv'
...
loan_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/dataset/t_loan.csv'
...
res_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/submit/1127_baseline2.csv'
res_df.to_csv(res_fn, index=False, header=False, columns=['uid', 'loan_amount'])

res_fn = '/Users/dingxuetao/Desktop/快盘/competition/2017jd/fantasy/submit/1127_baseline3.csv'
res_df = pd.merge(user_df, loansum_df, on='uid', how='left')
res_df['loan_sum'] = res_df['loan_sum'].fillna(value=1)
res_df.to_csv(res_fn, index=False, header=False, columns=['uid', 'loan_sum'])